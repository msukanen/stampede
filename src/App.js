			...
			<Row className="g-0">
				<Col xs={1} className="App-side-nav">
					<Container className="p-0">
						<Row>
							<Col><button onClick={() => setNumCols(1)}><code>1</code></button></Col>
							<Col><button onClick={() => setNumCols(2)}><code>2</code></button></Col>
							<Col><button onClick={() => setNumCols(3)}><code>3</code></button></Col>
							<Col><button onClick={() => setNumCols(4)}><code>4</code></button></Col>
							<Col><button onClick={() => setNumCols(5)}><code>5</code></button></Col>
						</Row>
					</Container>
